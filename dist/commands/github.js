...
exports.default = {
    metadata: {
        ...
        description: JSON.stringify({
            ...
            repository: "Finds and shows the information about the provided github repository. The information is fetched from the GitHub API.",
        }),
    },
    ...
    collector.on("collect", async (i) => {
        ...
        if (customId === "show_followers") {
            ...
            if (current_embed !== "followers") {
                ...
                if (followers == null) {
                    await i.reply({
                        content: `Couldn't fetch followers of ${(0, discord_js_1.bold)("@" + data.login)}`,
                        ephemeral: true,
                    });
                    return;
                }
        ...
        if (customId == "show_followings") {
            ...
            if (current_embed !== "followings") {
                ...
                if (followings == null) {
                    await i.reply({
                        content: `Couldn't fetch followings of ${(0, discord_js_1.bold)("@" + data.login)}`,
                        ephemeral: true,
                    });
                    return;
                }
        ...
        if (customId == "show_repos") {
            ...
            if (current_embed !== "repos") {
                ...
                if (repos == null) {
                    await i.reply({
                        content: `Couldn't fetch repositories of ${(0, discord_js_1.bold)("@" + data.login)}`,
                        ephemeral: true,
                    });
                    return;
                }
...
async function makeReq(ctx, url) {
